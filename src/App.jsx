...
const REGION_DATA = {
  ...
  경기인천권: [
    ...
    { name: '한양대(E)', g9: [2.0, 2.6], g5: [1.58, 2.08] },
    { name: '한국외대(G)', g9: [1.9, 2.5], g5: [1.52, 2.0] },
  ...
  충청권: [
    ...
    { name: '고려대(S)', g9: [2.5, 3.2], g5: [2.0, 2.55] },
    { name: '한국기술교대', g9: [2.1, 2.8], g5: [1.68, 2.22] },
    { name: '건국대(G)', g9: [2.7, 3.4], g5: [2.15, 2.72] },
    ...
    { name: '상명대(C)', g9: [3.2, 4.0], g5: [2.55, 3.18] },
    { name: '호서대', g9: [3.2, 4.0], g5: [2.55, 3.18] },
    { name: '백석대', g9: [3.5, 4.3], g5: [2.8, 3.42] },
    { name: '세명대', g9: [3.6, 4.5], g5: [2.88, 3.58] },
  ...
  대구경북권: [
    ...
    { name: '동국대(W)', g9: [3.0, 3.8], g5: [2.38, 3.0] },
  ...
  전라제주권: [
    { name: '전남대', g9: [2.1, 2.8], g5: [1.68, 2.25] },
    { name: '전북대', g9: [2.2, 2.9], g5: [1.75, 2.3] },
    { name: '제주대', g9: [2.4, 3.1], g5: [1.92, 2.48] },
    { name: '조선대', g9: [2.8, 3.6], g5: [2.25, 2.88] },
    { name: '원광대', g9: [2.9, 3.7], g5: [2.3, 2.95] },
  ...
  return (
    <div className="min-h-screen bg-slate-50 p-4 font-sans text-slate-900 md:p-8">
      ...
      <footer className="mx-auto mt-20 max-w-[1450px] border-t border-slate-200 py-10 text-center text-[11px] font-black uppercase tracking-[0.2em] text-slate-400 print:hidden">
        IPSISKETCH LAB. All rights reserved.
      </footer>
    </div>
  );
}
